...
// <![CDATA[
	...
	var mode = <?php if ($this->_rootref['QUICK_REPLY']) {  ?>'quick_reply'<?php } else { ?>''<?php } ?> ;
...
<?php if ($this->_rootref['S_AUTO_ADVERTISE_PUBLIC_FEED']) {  ?>

<link rel="alternate" type="application/rss+xml" title="RSS" href="<?php echo (isset($this->_rootref['U_SMARTFEED_URL'])) ? $this->_rootref['U_SMARTFEED_URL'] : ''; ?>?<?php echo (isset($this->_rootref['U_RSS_PARAMETERS'])) ? $this->_rootref['U_RSS_PARAMETERS'] : ''; ?>" />
<link rel="alternate" type="application/atom+xml" title="ATOM" href="<?php echo (isset($this->_rootref['U_SMARTFEED_URL'])) ? $this->_rootref['U_SMARTFEED_URL'] : ''; ?>?<?php echo (isset($this->_rootref['U_ATOM_PARAMETERS'])) ? $this->_rootref['U_ATOM_PARAMETERS'] : ''; ?>" />
...
<?php } $this->_tpl_include('ads/ads.js'); ?>
...
<div id="wrap">
	...
	<div id="page-header">
		<?php echo (isset($this->_rootref['ADS_1'])) ? $this->_rootref['ADS_1'] : ''; ?>

		<div class="headerbar">
			<div class="inner"><span class="corners-top"><span></span></span>

			<div id="site-description">
				<!--<a href="http://www.vxzone.com" title="VXZone" id="logo"><?php echo (isset($this->_rootref['SITE_LOGO_IMG'])) ? $this->_rootref['SITE_LOGO_IMG'] : ''; ?></a>-->
				<div><h1><?php echo (isset($this->_rootref['SITENAME'])) ? $this->_rootref['SITENAME'] : ''; ?></h1>
				<p><?php echo (isset($this->_rootref['SITE_DESCRIPTION'])) ? $this->_rootref['SITE_DESCRIPTION'] : ''; ?></p></div>
		...
		<div class="navbar">
			...
			<ul class="linklist rightside">
				<li class="icon-smartfeed"><a href="<?php echo (isset($this->_rootref['U_SMARTFEED'])) ? $this->_rootref['U_SMARTFEED'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_SMARTFEED_SHORT_EXPLAIN'])) ? $this->_rootref['L_SMARTFEED_SHORT_EXPLAIN'] : ((isset($user->lang['SMARTFEED_SHORT_EXPLAIN'])) ? $user->lang['SMARTFEED_SHORT_EXPLAIN'] : '{ SMARTFEED_SHORT_EXPLAIN }')); ?>"><?php echo ((isset($this->_rootref['L_SMARTFEED'])) ? $this->_rootref['L_SMARTFEED'] : ((isset($user->lang['SMARTFEED'])) ? $user->lang['SMARTFEED'] : '{ SMARTFEED }')); ?></a></li>
	...
	<div id="page-body">
		...
		<div class="promo">
			<?php echo (isset($this->_rootref['ADS_2'])) ? $this->_rootref['ADS_2'] : ''; ?>
